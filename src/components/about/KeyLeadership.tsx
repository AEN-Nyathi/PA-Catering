...
const KeyLeadership: React.FC = () => {
	return (
		<Section
			...
			heading='P.A Catering is driven by a dedicated leadership team with a diverse range of expertise.
			...
			<article className='leading-relaxed p-4 mt-4 text-base md:text-lg'>
				<p>A.E.N Nyathi brings a wealth of knowledge and skills to P.A Catering, including:</p>
				...
				<p className='mt-4'>
					...
					operational workflows. A.E.N Nyathi&apos;s contributions ensure that P.A Catering
